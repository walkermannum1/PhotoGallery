...
public class WeiboFetcher {
    ...
    private static final String TAG = "WeiboFetcher";
    private static final String API_KEY = "2133803110";
    ...
    public void fetchItems() {
        try {
            String url = Uri.parse("http://open.weibo.com/services/rest/").buildUpon().appendQueryParameter("method", "weibo.photos.getPeople")
